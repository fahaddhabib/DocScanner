package com.psychoutilities.camscan.db;
...
public class HelperDB extends SQLiteOpenHelper {
    ...
    public void addGroup(ModelDB dBModel) {
        SQLiteDatabase writableDatabase = getWritableDatabase();
    ...
    private boolean isGroupNameExist(Activity activity, String str) {
        ...
        if (count > 0) {
            Toast.makeText(activity, activity.getResources().getString(R.string.document_name_already_exist), Toast.LENGTH_SHORT).show();
        }
        rawQuery.close();
        if (count >= 1) {
            return true;
    ...
    public ArrayList<ModelDB> getAllGroups() {
        ArrayList<ModelDB> arrayList = new ArrayList<>();
        Cursor rawQuery = getReadableDatabase().rawQuery("SELECT  * FROM alldocs", (String[]) null);
        if (rawQuery.moveToFirst()) {
            do {
                ModelDB dBModel = new ModelDB();
    ...
    public ArrayList<ModelDB> getOnlyAllGroups() {
        ArrayList<ModelDB> arrayList = new ArrayList<>();
        Cursor rawQuery = getReadableDatabase().rawQuery("SELECT  * FROM alldocs", (String[]) null);
        if (rawQuery.moveToFirst()) {
            do {
    ...
    public ArrayList<ModelDB> getGroupsByTag(String str) {
        ArrayList<ModelDB> arrayList = new ArrayList<>();
    ...
    public ArrayList<ModelDB> getGroupDocs(String str) {
        ArrayList<ModelDB> arrayList = new ArrayList<>();
    ...
    public ArrayList<ModelDB> getShareGroupDocs(String groupName) {
        ArrayList<ModelDB> arrayList = new ArrayList<>();
