...
import com.psychoutilities.camscan.BuildConfig;
...
public class AdsAdmob {
    public static String PKG_APP = "com.psychoutilities.camscan";
        ...
        AdLoader.Builder builder = new AdLoader.Builder((Context) activity, activity.getString(R.string.admob_native_ad))
                .forNativeAd(new NativeAd.OnNativeAdLoadedListener() {
                    ...
                    public void onNativeAdLoaded(NativeAd nativeAd) {
                        AdsAdmob.populateNativeAdView(nativeAd, nativeAdView);
