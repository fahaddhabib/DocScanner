...
public class PreviewCamera extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void init(WrapperCamera cameraWrapper, Camera.PreviewCallback previewCallback) {
        setCamera(cameraWrapper, previewCallback);
        this.mAutoFocusHandler = new Handler();
        getHolder().addCallback(this);
        getHolder().setType(3);
    }
    public void setCamera(WrapperCamera cameraWrapper, Camera.PreviewCallback previewCallback) {
    ...
    private Camera.Size getOptimalPreviewSize() {
        ...
        if (UtilDisplay.getScreenOrientation(getContext()) == 1) {
            int i = height;
            height = width;
            width = i;
        }
    ...
    public WrapperCamera mCameraWrapper;
    private Camera.PreviewCallback mPreviewCallback;
    public boolean mPreviewing = true;
    private boolean mShouldScaleToFill = true;
    public boolean mSurfaceCreated = false;
    public PreviewCamera(Context context, WrapperCamera cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }
    public PreviewCamera(Context context, AttributeSet attributeSet, WrapperCamera cameraWrapper, Camera.PreviewCallback previewCallback) {
