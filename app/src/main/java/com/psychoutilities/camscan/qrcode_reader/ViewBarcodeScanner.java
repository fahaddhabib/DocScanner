...
public abstract class ViewBarcodeScanner extends FrameLayout implements Camera.PreviewCallback {
    ...
    private HandlerThreadCamera mCameraHandlerThread;
    private WrapperCamera mCameraWrapper;
    ...
    private FinderIView mViewFinderView;

    public ViewBarcodeScanner(Context context) {
        super(context);
        init();
    }


    public ViewBarcodeScanner(Context context, AttributeSet attributeSet) {
    ...
    public final void setupLayout(WrapperCamera cameraWrapper) {
        removeAllViews();
        mPreview = new PreviewCamera(getContext(), cameraWrapper, this);
    ...
    public FinderIView createViewFinderView(Context context) {
        ViewFinder viewFinderView = new ViewFinder(context);
    ...
    public void startCamera(int i) {
        if (mCameraHandlerThread == null) {
            mCameraHandlerThread = new HandlerThreadCamera(this);
        }
    ...
    public void setupCameraPreview(WrapperCamera cameraWrapper) {
    ...
    public void startCamera() {
        startCamera(UtilCamera.getDefaultCameraId());
    }

    public void stopCamera() {
        if (mCameraWrapper != null) {
            mPreview.stopCameraPreview();
            mPreview.setCamera((WrapperCamera) null, (Camera.PreviewCallback) null);
    ...
    public void setFlash(boolean z) {
        ...
        if (mCameraWrapper != null && UtilCamera.isFlashSupported(mCameraWrapper.mCamera)) {
    ...
    public boolean getFlash() {
        ...
        if (mCameraWrapper == null || !UtilCamera.isFlashSupported(mCameraWrapper.mCamera) || !mCameraWrapper.mCamera.getParameters().getFlashMode().equals("torch")) {
            return false;
        }
        return true;
    }
