...
public class ActNote extends BaseAct {

    public String current_doc_name, group_name, text;
    ...
    private void bindView() {
        ...
        findViewById(R.id.iv_save_note).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ActNote.this, getResources().getString(R.string.note_saved), Toast.LENGTH_SHORT).show();
                BaseAct.hideKeyboard(ActNote.this);
