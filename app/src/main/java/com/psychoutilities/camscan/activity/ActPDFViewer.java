...
public class ActPDFViewer extends BaseAct implements OnPageChangeListener, OnLoadCompleteListener, OnPageErrorListener {

    private static final String TAG = "PDFViewerActivity";
    private int page_no = 0;
    protected String title;
    protected TextView tv_page, tv_title;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.pdfviewer_act);
        init();
    }
