...
public class FragmentAspectRatio extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        if (aspectRatioArr != null) {
            ...
            return new AlertDialog.Builder(getActivity()).setAdapter(new AdapterAspectRatio(aspectRatioArr, (AspectRatio) arguments.getParcelable(ARG_CURRENT_ASPECT_RATIO)), new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialogInterface, int i) {
                    FragmentAspectRatio.this.mListener.onAspectRatioSelected(aspectRatioArr[i]);
                }
            }).create();
        }
    ...
    public static FragmentAspectRatio newInstance(Set<AspectRatio> set, AspectRatio aspectRatio) {
        FragmentAspectRatio aspectRatioFragment = new FragmentAspectRatio();
    ...
    private static class AdapterAspectRatio extends BaseAdapter {
        private final AspectRatio mCurrentRatio;
        private final AspectRatio[] mRatios;

        AdapterAspectRatio(AspectRatio[] aspectRatioArr, AspectRatio aspectRatio) {
