...
final class EncoderVCardContact extends EncoderContact {
    ...
    public String[] encode(List<String> names,
        ...
        Formatter fieldFormatter = new FormatterVCardField();
        ...
        appendUpToUnique(newContents, newDisplayContents, "TEL", phones, Integer.MAX_VALUE,
                new FormatterVCardTelDisplay(phoneMetadata),
                new FormatterVCardField(phoneMetadata), TERMINATOR);
