...
final class FormatterVCardTelDisplay implements Formatter {
    ...
    FormatterVCardTelDisplay() {
        this(null);
    }

    FormatterVCardTelDisplay(List<Map<String,Set<String>>> metadataForIndex) {
